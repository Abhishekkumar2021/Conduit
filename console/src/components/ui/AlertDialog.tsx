...
const AlertDialogFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end pt-1", className)}
    {...props}
  />
);
